      ...
      <div className="xl:w-4/5 px-6 max-w-[1400px] mx-auto relative lg:h-[70vh] flex flex-col justify-center">
        ...
        <div className="h-full flex justify-center items-center w-full overflow-hidden">
          <div className="bg-dark rounded-full shadow relative lg:w-96 w-64 lg:h-96 h-64">
            <div className="flex flex-col items-center justify-center bg-gradient-to-r from-color1 to-color1 rounded-full p-4 absoluted top-0 z-20">
            ...
            <button className="text-white bg-gradient-to-r from-color2 to color1 rounded-full shadow-2x1 absolute w-10 h-10 top-8 right-5 z-20 flex items-center justify-center">
              <HiPlus size={20} />
            </button>
          </div>
        ...
        <div className="lg:absolute lg:w-1/3">
          ...
          <h2 className="text-5xl text-white font-bold py-8">Sapatos de marca.</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sodales ligula lorem, accumsan fringilla enim lobortis id. Sed fringilla ex suscipit fermentum vulputate.
          </p>
        </div>
